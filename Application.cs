...
namespace SimUcApp
{
    public class Application
    {
        ...
        private string SignRequest<T>(T request)
        {
            ...
            (request as SimUcRequest.BaseApiRequest).Time = (int)(DateTime.UtcNow - new DateTime(1970, 1, 1, 0, 0, 0, 0)).TotalSeconds;
        ...
        /// <returns></returns>
        public SimApiBaseResponse UpdateCard(int userId, int groupId, CardDataTypeEnum type, string data, string image = null)
        {
        ...
        /// <param name="image"></param>
        /// <returns></returns>
        public SimApiBaseResponse SendMessage(int userId, CardDataTypeEnum type, string text, string title = null, string image = null)
        {
        ...
        /// <returns></returns>
        public SimUcResponse.GetUserByTokenResponse GetUserByToken(string token)
        {
            ...
            var body = SignRequest(request);
            var resp = Query("/token", body);
            return JsonConvert.DeserializeObject<SimUcResponse.GetUserByTokenResponse>(resp);
        }
        ...
        /// <returns></returns>
        public SimUcResponse.TradeCheckResponse TradeCheck(string tradeNo)
        {
            ...
            return JsonConvert.DeserializeObject<SimUcResponse.TradeCheckResponse>(resp);
        }
    }
